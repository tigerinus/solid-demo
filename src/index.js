...
async function createList() {
  ...
  try {
    ...
    savedReadingList = await getSolidDataset(readingListUrl, { fetch });
...
buttonLogin.onclick = () => loginToSelectedIdP();

buttonRead.onclick = () => getMyPods();

buttonCreate.onclick = () => createList();
